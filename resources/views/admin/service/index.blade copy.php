...
@section('content')
<div class="toolbar">
    <button type="button" class="btn" id="newBtn">Add New Service</button>
</div>

<div class="card" id="contentContainer">
    <table class="custom-table" id="example1">
        <thead>
            <tr>
                <th>Sl</th>
                <th>Title</th>
...
<div class="modal-backdrop" id="addThisFormContainer">
    <div class="modal">
        <header>
            <h3 id="cardTitle">Add New Service</h3>
        </header>
        <div class="content">
            <form id="createThisForm">
                ...
                <div class="field">
                    ...
                    <textarea class="form-control summernote" id="long_desc" name="long_desc" placeholder="Enter detailed description"></textarea>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="field">
                            ...
                            <div class="file-preview">
                                <img id="preview-icon" src="#" alt="Icon preview" style="display: none; max-width: 100px; margin-top: 10px;">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <div class="file-preview">
                                <img id="preview-meta-image" src="#" alt="Meta image preview" style="display: none; max-width: 200px; margin-top: 10px;">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <footer>
            <button class="btn ghost" id="FormCloseBtn">Cancel</button>
            <button class="btn" id="addBtn">Save</button>
        </footer>
    </div>
</div>
@endsection
