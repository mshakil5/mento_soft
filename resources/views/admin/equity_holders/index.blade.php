    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Equity Holder</h4>
...
<script>
    ...
    var charturl = "{{URL::to('/admin/equity-holders')}}";
