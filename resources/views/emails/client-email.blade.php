      ...
      <tr>
        <td align="center" style="padding:20px;">
          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="container" style="max-width:600px;background-color:#ffffff;border-radius:12px;overflow:hidden;border:none;">
            <tr>
              <td style="padding:32px 24px 16px 24px;" class="p-32" align="center">
                <p style="margin:12px 0 20px 0;font-size:15px;line-height:1.6;color:#444;">
                  {!! $body ?? '' !!}
                </p>
              </td>
            </tr>
            ...
            <tr>
              <td style="background-color:#f8f8f8;padding:20px;font-size:12px;color:#555;text-align:center;">
                <p style="margin:0;">
                  &copy; {{ date('Y') }} Mento Software. All rights reserved.
                </p>
                <p style="margin:4px 0 0 0;">
                  <a href="https://www.mentosoftware.co.uk/" style="color:#FF6D33;text-decoration:none;">Visit Website</a>
                </p>
              </td>
            </tr>
          </table>
